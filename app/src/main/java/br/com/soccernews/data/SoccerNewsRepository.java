...
public class SoccerNewsRepository {
    ...
    //region Constantes
    private static final String REMOTE_API_URL = "https://luizsabiano.github.io/mock_handicraft/";
    private static final String LOCAL_DB_NAME = "soccer_news";
    //endregion
